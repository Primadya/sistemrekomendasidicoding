...
input_value = st.text_input("🍽️ Masukkan nama makanan yang Anda suka:")
if input_value:
...
if st.button('Dapatkan Rekomendasi Makanan dengan Collaborative Filtering'):
    with st.spinner("🔄 Menghitung rekomendasi..."):
        ...
        user_encoder = user_id  # jika tidak ada encoder mapping
        ...
        st.subheader(f"🎯 Rekomendasi CF untuk Pengguna {user_id}:")
